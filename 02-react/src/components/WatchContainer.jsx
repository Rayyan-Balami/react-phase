...
export default function WatchContainer() {
  return (
    ...
    <div className="group before:absolute before:bg-pink-500 before:w-3 before:h-12 before:top-24 before:-right-2 before:-z-10 before:rounded-2xl before:shadow-inner before:shadow-gray-50 relative w-60 h-60 bg-pink-500 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
        <div className="w-56 h-56 bg-neutral-900 shadow-inner shadow-gray-50 flex justify-center items-center rounded-3xl">
          <div className="flex flex-col items-center justify-center rounded-2xl bg-neutral-900 shadow-inner shadow-gray-50 w-52 h-52">
              ...
              <div className="text-gray-50 w-48 flex flex-row justify-evenly">
                ...
                <div className="flex flex-row items-center">
                  <svg className="w-5 h-5 fill-red-500 animate-bounce" height={100} preserveAspectRatio="xMidYMid meet" viewBox="0 0 100 100" width={100} x={0} xmlns="http://www.w3.org/2000/svg" y={0}>
                    <path d="M23,27.6a15.8,15.8,0,0,1,22.4,0L50,32.2l4.6-4.6A15.8,15.8,0,0,1,77,50L50,77,23,50A15.8,15.8,0,0,1,23,27.6Z" fillRule="evenodd">
                    </path>
                  </svg>
            ...
            <span className="text-gray-700 text-lg font-light ">Smart Watch</span>
          </div>
        </div>
      </div>
      <span className="text-gray-400 mt-10 text-xl font-mono font-semibold capitalize">Hover over the screen to activate it</span>
      </div>
  );
}
